...
- 本地 PDF：`C:\Users\chaol\Desktop\推荐论文阅读\re-ranking\longtermvalue\2404.17589 - RL最大化手拍的长期价值.pdf`
- 笔记位置：`50-论文笔记/精排/LTR与多目标融合/UnifiedRL.md`
- 分类：精排 / LTR与多目标融合
...
![[UnifiedRL.assets/unifiedrl_fig1_session.png|620]]
...
![[UnifiedRL.assets/unifiedrl_fig2_action_diff.png|520]]
...
![[UnifiedRL.assets/unifiedrl_fig3_exploration_policy.png|520]]
...
![[UnifiedRL.assets/unifiedrl_fig4_framework.png|620]]
...
![[UnifiedRL.assets/unifiedrl_fig5_system.png|560]]
...
![[UnifiedRL.assets/unifiedrl_table1_offline_reward.png|560]]
...
![[UnifiedRL.assets/unifiedrl_table2_mtf_gauc.png|560]]
...
![[UnifiedRL.assets/unifiedrl_table3_online.png|560]]
...
- 设计/流程图：图 1（session 内用户—推荐系统交互）、图 2（新旧 policy 的 action 差异）、图 3（有界均匀探索与 Gaussian 噪声）、图 4（actor / target actor 与多组 critic）、图 5（线上服务—离线训练闭环）均已嵌入并逐图解释。
- 结果表：表 1（NCIS cumulative reward）、表 2（MTF-GAUC）和表 3（线上 UVC / UDT）均已嵌入；表中数字已在实验章节连接回“已知探索边界降低过度保守 OOD 约束、PTM 再带来增益”的论文论点。
